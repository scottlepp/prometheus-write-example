...
async function main(): Promise<void> {
  console.log('🚀 Enhanced Complex Prometheus Remote Write Test');
  ...
  const queries = [
    ...
    { query: 'process_cpu_seconds_total', name: 'Process CPU' }
  ];
  ...
  console.log('   - Try queries like: http_requests_total{method="GET"}');
}
